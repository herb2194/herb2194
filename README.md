<p align="center">
  <img src="./assets/banner/github-banner.png" width="100%" alt="Moon Yeji GitHub Banner" />
</p>
...
팀 프로젝트에서는 실시간 라이브 스트리밍, 채팅, 결제, 권한 관리 기능을 담당했고,  
개인 프로젝트에서는 AI 기반 패션 커머스 플랫폼을 기획부터 주요 기능 구현까지 진행했습니다.

프론트엔드 화면 구현부터 백엔드 API, 데이터 흐름, 사용자 권한 처리까지  
하나의 서비스가 동작하는 전체 과정을 경험하며 학습하고 있습니다.
...
👉 **[STYLINK 상세 README 보러가기](https://github.com/herb2194/stylink/tree/dev)**
...
![Stylink Preview](./assets/gif/stylink-feed.gif)
...
👉 **[GNEUL 상세 README 보러가기](https://github.com/herb2194/gneul)**
...
![GNEUL Preview](./assets/gif/gneul-live.gif)
